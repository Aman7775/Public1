...
// Mock data for diagnostic centers with free home sample collection
const centers = [
    {
        id: 1,
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.headerTitle}>Free Home Sample Collection</Text>
                <View style={{ width: 32 }} />
            </View>
            <ScrollView contentContainerStyle={styles.scrollContent}>
                {centers.length === 0 ? (
                    <View style={styles.emptyState}>
                        <Text style={styles.emptyText}>No diagnostic centers found offering free home sample collection.</Text>
                    </View>
                ) : (
                    centers.map(center => (
                        <TouchableOpacity
