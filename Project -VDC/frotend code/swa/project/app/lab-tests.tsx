...
const LabTests: React.FC = () => {
  ...
  const filteredSpecializedAdvancedTests = specializedAdvancedTests.filter((
    test
  ) => test.name.toLowerCase().includes(searchTextBlood.toLowerCase()));
        ...
        <View style={styles.categorySliderContainer}>
          <TouchableOpacity
            style={[
              ...
              activeTab === "blood" && styles.activeCategorySliderButton,
            ]}
          ...
          >
            <View>
              <Text
                style={[
                  styles.categorySliderMainText,
                  activeTab === "blood" && styles.activeCategorySliderMainText,
                ]}
              >
                Blood Tests
              </Text>
              <Text
                style={[
                  styles.categorySliderSubText,
                  activeTab === "blood" && styles.activeCategorySliderSubText,
                ]}
              >
                CBC, Packages...
              </Text>
          ...
          <TouchableOpacity
            style={[
              styles.categorySliderButton,
              activeTab === "imaging" && styles.activeCategorySliderButton,
            ]}
          ...
          >
            <View>
              <Text
                style={[
                  styles.categorySliderMainText,
                  activeTab === "imaging" && styles.activeCategorySliderMainText,
                ]}
              >
                X-Ray, Scans
              </Text>
              <Text
                style={[
                  styles.categorySliderSubText,
                  activeTab === "imaging" && styles.activeCategorySliderSubText,
                ]}
              >
                Ultrasound, MRI...
              </Text>
                ...
                <>
                  ...
                  {filteredBloodTests.map((test, index) => (
                    <TestCard
                      ...
                      onBookNow={() => handleBookNow(test.name)}
                    />
                  ))}
...
const styles = StyleSheet.create({
  ...
  container: {
    flex: 1,
    backgroundColor: Colors.background,
    paddingTop: Platform.OS === "android" ? 0 : 0, // Adjust for safe area on iOS
  },
  headerLogo: {
    width: 30,
    height: 30,
