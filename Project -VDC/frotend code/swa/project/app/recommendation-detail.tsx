...
// Mock data for diagnostic centers with recommended tests
const centers = [
    {
        id: 1,
        ...
        accreditation: 'NABL',
        tests: ['Liver & Kidney Panel', 'HbA1c'],
    },
    {
        id: 2,
...
export default function RecommendationDetail() {
    ...
    // Filter centers that offer the selected test
    const filteredCenters = centers.filter(center => center.tests.includes(name));
            ...
            <ScrollView contentContainerStyle={styles.scrollContent}>
                {filteredCenters.length === 0 ? (
                    <View style={styles.emptyState}>
                        <Text style={styles.emptyText}>No diagnostic centers found offering {name}.</Text>
                    </View>
                ) : (
